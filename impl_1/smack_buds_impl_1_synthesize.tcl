...
global para
set para(gui_mode) 1
set para(prj_dir) "//vs-home/tlyons01/es4/smack_buds"
# synthesize IPs
# synthesize VMs
...
run_postsyn [list -a iCE40UP -p iCE40UP5K -t SG48 -sp High-Performance_1.2V -oc Industrial -top -w -o smack_buds_impl_1_syn.udb smack_buds_impl_1.vm] "//vs-home/tlyons01/es4/smack_buds/impl_1/smack_buds_impl_1.ldc"
